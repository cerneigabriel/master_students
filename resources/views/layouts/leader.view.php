...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo url("leader.index"); ?>">
                <div class="sidebar-brand-text text-left mx-3">Leader Panel</div>
            </a>

            <hr class="sidebar-divider my-0">

            <?php if (Auth::user()->can("view_leader_dashboard")) : ?>
                <li class="nav-item <?php echo router()->current_route->name == "leader.index" ? "active" : ""; ?>">
                    <a class="nav-link" href="<?php echo url("leader.index"); ?>">
